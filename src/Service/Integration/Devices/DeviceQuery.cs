...
// Created Date: 2024-1-13 18:53
// Modified By: Godwin peter .O
// Last Modified: 2024-1-13 18:53
...
public class DeviceQuery {
    ...
    public IQueryable<Device> GetDevices([Service(ServiceKind.Synchronized)] IDeviceRepository deviceRepository) => deviceRepository.GetAll().Where(x => x.UniqueId != null);
}